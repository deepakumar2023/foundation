    ...
    <div className="pt-24 pb-16 bg-surface">
      <div className="container mx-auto px-4 xl:px-8 max-w-4xl">
        ...
        <div className="prose prose-lg text-text-main">
          ...
          <h2 className="text-2xl font-semibold text-text-main mt-8 mb-4">1. Introduction</h2>
          <p className="mb-4">
          ...
          <h2 className="text-2xl font-semibold text-text-main mt-8 mb-4">2. Data We Collect</h2>
          <p className="mb-4">
          ...
          <h2 className="text-2xl font-semibold text-text-main mt-8 mb-4">3. How We Use Your Data</h2>
          <p className="mb-4">
          ...
          <h2 className="text-2xl font-semibold text-text-main mt-8 mb-4">4. Data Security</h2>
          <p className="mb-4">
            We have put in place appropriate security measures to prevent your personal data from being accidentally lost, used or accessed in an unauthorised way, altered or disclosed. In addition, we limit access to your personal data to those employees, agents, contractors and other third parties who have a business need to know.
          </p>

          <h2 className="text-2xl font-semibold text-text-main mt-8 mb-4">5. Your Legal Rights</h2>
          <p className="mb-4">
            Under certain circumstances, you have rights under data protection laws in relation to your personal data. These include the right to request access, correction, erasure, restriction, transfer, to object to processing, to portability of data and (where the lawful ground of processing is consent) to withdraw consent.
          </p>

          <h2 className="text-2xl font-semibold text-text-main mt-8 mb-4">6. Contact Us</h2>
          <p className="mb-4">
