            ...
            <main className="max-w-[1140px] mx-auto px-[24px]">
                ...
                <section className="py-[48px] md:py-[80px] flex flex-col md:flex-row items-center gap-[40px]">
                    ...
                    <div className="flex-grow text-center md:text-left">
                        ...
                        <p className="text-[18px] md:text-[20px] font-medium text-[#b08d57] mb-[24px] leading-tight">Founder &amp; Managing Director, DEEPAK GUPTA FOUNDATION </p>
                        <p className="text-[#44474e] leading-relaxed text-[16px] md:text-[18px]">
                            Deepak Gupta is the Founder and Director DEEPAK GUPTA FOUNDATION, a mission-driven conglomerate built around manufacturing, healthcare equity, and industrial-scale solutions. He is regularly counted among the visionary leaders in India's emerging industrial landscape.
                        </p>
                    </div>
                </section>
                ...
                <section className="py-[48px]">
                    ...
                    <div className="relative ml-[16px] pl-[40px] space-y-[48px]">
                        ...
                        <div className="relative">
                            ...
                            <h4 className="text-[20px] font-bold text-[#001b3d] mb-[8px]">DEEPAK GUPTA FOUNDATION  Founded</h4>
                            <p className="text-[#44474e] text-[16px] font-medium">The official establishment of DEEPAK GUPTA FOUNDATION  of Industries, a mission-driven conglomerate aimed at healthcare equity.</p>
                        </div>
                    </div>
                </section>
                ...
                <section className="py-[48px]">
                    <div className="bg-[#f0f3ff] p-[32px] md:p-[64px] relative overflow-hidden rounded-md">
                        ...
                        <div className="text-[#44474e] text-[16px] md:text-[18px] space-y-[24px] relative z-10 leading-relaxed max-w-3xl">
                            ...
                            <p>
                                When I founded DEEPAK GUPTA FOUNDATION , I did so with a commitment that goes beyond the balance sheet. In an industry often blinded by margins, we choose to prioritize health outcomes over revenue streams.
                            </p>
                            <p>
                                Our country is at a turning point. We have the talent, we have the drive, and now, with DEEPAK GUPTA FOUNDATION , we have the industrial backbone to ensure that no Indian is left behind because of where they were born or what they can afford.
                            </p>
