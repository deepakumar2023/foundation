    ...
    <div className="pt-24 pb-16 bg-white">
      <div className="container mx-auto px-4 xl:px-8 max-w-4xl">
        ...
        <div className="prose prose-lg text-gray-700">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">3. Intellectual Property Rights</h2>
          <p className="mb-4">
          ...
          <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">5. Modifications to Terms</h2>
          <p className="mb-4">
