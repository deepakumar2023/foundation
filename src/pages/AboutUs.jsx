    ...
    <div className="w-full overflow-hidden font-sans">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16 py-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 text-center">
          <div className="p-8 rounded-2xl bg-white shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-gray-100 hover:shadow-lg transition-shadow duration-300 transform hover:-translate-y-1">
            ...
            <h3 className="text-xl font-medium text-gray-800 mb-3">Pan-India Reach</h3>
            <p className="text-gray-600 font-light text-sm leading-relaxed">Impacting millions of lives across multiple states, focusing on rural and remote areas to bring inclusive growth.</p>
          </div>
          ...
          <div className="p-8 rounded-2xl bg-white shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-gray-100 hover:shadow-lg transition-shadow duration-300 transform hover:-translate-y-1">
            ...
            <h3 className="text-xl font-medium text-gray-800 mb-3">Core Themes</h3>
            <p className="text-gray-600 font-light text-sm leading-relaxed">Dedicated focus on Education, Health, Sustainable Livelihoods, and Climate Action for holistic community development.</p>
          </div>
          ...
          <div className="p-8 rounded-2xl bg-white shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-gray-100 hover:shadow-lg transition-shadow duration-300 transform hover:-translate-y-1">
            ...
            <h3 className="text-xl font-medium text-gray-800 mb-3">Community First</h3>
            <p className="text-gray-600 font-light text-sm leading-relaxed">Working closely with local communities to understand their needs and co-create sustainable, impactful solutions.</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gray-50 py-20">
        <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16">
          <h2 className="text-3xl font-light text-gray-800 mb-12 text-center">Explore Who We Are</h2>
