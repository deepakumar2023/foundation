    ...
    <div className="w-full overflow-hidden font-sans">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 lg:px-16 py-16 md:py-24 space-y-20">
        ...
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-light text-gray-800 mb-6">Life at Deepak Gupta Foundation</h2>
        ...
        <div className="bg-[#f2f8f8] rounded-2xl p-8 md:p-12 text-center max-w-4xl mx-auto border border-[#e0f0f0]">
          <h2 className="text-2xl md:text-3xl font-medium text-gray-800 mb-4">How We Hire and Onboard</h2>
        ...
        <div>
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-light text-gray-800 mb-4">Values in Action</h2>
        ...
        <div className="bg-white p-10 md:p-16 rounded-3xl shadow-lg border border-gray-100 text-center relative overflow-hidden max-w-5xl mx-auto">
          <div className="absolute top-0 left-0 w-2 h-full bg-[#8a2176]"></div>
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-6">Our Commitment to Dignity</h2>
