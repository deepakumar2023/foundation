  ...
  return (
    <div className="bg-[#f2eef4] w-full pt-20 pb-16 px-4 md:px-8 lg:px-16 relative">
      ...
      <div className="max-w-6xl mx-auto flex flex-col items-center md:items-stretch space-y-16 md:space-y-8 py-8">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start max-w-md md:self-start md:ml-[5%]">
          ...
          <div className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-sm text-sm relative z-0 md:-ml-12 pt-12 md:pt-6 md:pl-16">
            <p className="text-gray-700 leading-relaxed">
              <span className="font-bold text-gray-900">Leelaben Parmar</span> - "Before the new road, getting our produce to the market during monsoons was impossible. Half our vegetables would rot. Now, the market is just 20 minutes away, all year round..." 
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row-reverse items-center md:items-start max-w-md md:self-end md:mr-[5%] md:-mt-12">
          ...
          <div className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-sm text-sm relative z-0 md:-mr-12 pt-12 md:pt-6 md:pr-16 text-right">
            <p className="text-gray-700 leading-relaxed">
              <span className="font-bold text-gray-900">Raju Bhai</span> - "Our village finally has a community hall. Weddings, panchayat meetings, festivals... everything happens here now. It has truly brought us all together under one roof."
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start max-w-md md:self-start md:ml-[15%] md:-mt-12">
          ...
          <div className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-sm text-sm relative z-0 md:-ml-12 pt-12 md:pt-6 md:pl-16">
            <p className="text-gray-700 leading-relaxed">
              <span className="font-bold text-gray-900">Sunita Patel</span> - "The RO plant installed in our village means my kids don't fall sick as often. Clean drinking water was a luxury, now it is our right. We are very thankful for this facility."
            </p>
          </div>
        </div>
      ...
      <div className="max-w-4xl mx-auto text-center mt-12 text-sm text-gray-600 leading-relaxed px-4 pb-8 space-y-4">
        <p>The Adani Foundation focuses on building robust rural infrastructure that serves as the backbone for community progress. From constructing roads that connect remote villages to markets, to building community halls that foster social cohesion, our interventions aim to elevate the standard of living.</p>
