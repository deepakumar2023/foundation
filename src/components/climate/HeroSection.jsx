  ...
  return (
    <div className="bg-[#f2eff4] w-full pt-20 pb-16 px-4 md:px-8 lg:px-16 relative">
      ...
      <div className="max-w-4xl mx-auto text-center mt-12 text-sm text-text-muted leading-relaxed px-4 pb-8 space-y-4">
        ...
        <p className="font-medium text-text-main">Water Positivity: We are moving towards making all our power plants water-positive, thereby reducing dependency on freshwater sources.</p>
        <p className="font-medium text-text-main">Biodiversity Enhancement: Preserving biodiversity, maintaining green covers and striving towards 'no net loss' of biological diversity across all operational areas.</p>
