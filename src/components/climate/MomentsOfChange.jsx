...
const MomentsOfChange = () => {
  const videos = [
    {
      ...
      title: "Community Water Conservation Efforts"
    },
    {
      id: 2,
      title: "Foundation led Water Conservation Efforts",
      image: "https://picsum.photos/600/400?random=96"
    },
    {
      id: 3,
      title: "Access to Clean Drinking Water in the Community",
  ...
  return (
    <div className="w-full py-16 bg-[#f2eff4] px-4 md:px-8 lg:px-16">
