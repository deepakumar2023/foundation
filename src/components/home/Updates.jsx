    ...
    <section className="py-20 bg-gray-50">
      <div className="container mx-auto px-4 xl:px-8 max-w-7xl">
        <div className="flex justify-between items-end mb-12">
          <div>
            <h2 className="text-3xl md:text-4xl font-bold text-text-main mb-2">Latest Updates</h2>
            <p className="text-text-muted">Stay connected with our latest initiatives and stories of change.</p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {updates.map((update) => (
            <div key={update.id} className="bg-surface rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition-shadow duration-300">
              <div className="p-6">
                {/* Header */}
                <div className="flex justify-between items-start mb-4">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-text-muted text-xs">{update.handle} · {update.date}</p>
                    </div>
                  </div>
                ...
                {/* Content */}
                <p className="text-text-main text-sm mb-4 leading-relaxed line-clamp-3">
                  {update.content}
                </p>
              </div>
