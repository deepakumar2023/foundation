    ...
    <section className="py-4 bg-surface relative">
      ...
      <div className="container mx-auto px-4 xl:px-8 text-center max-w-4xl relative z-10">
        <div className="mb-6 flex justify-center">
          <div className="w-16 h-1 bg-gradient-to-r from-[var(--color-primary)] to-primary rounded-full"></div>
        </div>
        <h2 className="text-3xl md:text-4xl font-bold text-text-main mb-6 leading-tight">
          ...
          <span className="text-2xl md:text-3xl font-medium text-text-main leading-relaxed block mt-8">
