      ...
      <div className="container mx-auto px-4 xl:px-8">
        <div className="relative w-full max-w-[1100px] mx-auto min-h-[700px] hidden md:block">
          ...
          <div className="absolute left-0 bottom-[10%] w-[280px] h-[280px] rounded-full bg-[#fbf5f9] flex items-center justify-center p-10 z-0">
            <p className="text-[22px] text-gray-800 leading-snug font-medium text-center">
        ...
        <div className="md:hidden flex flex-col gap-12 mt-20">
          <div className="relative">
            ...
            />
            <div className="absolute -bottom-6 right-4 bg-white p-4 rounded-xl shadow-lg border border-gray-100 flex items-center">
              <div className="w-8 h-[2px] bg-[#8a2176] mr-3"></div>
              <p className="text-sm text-[#8a2176] font-medium">Farmers who understand their soil</p>
            </div>
          </div>
          ...
          <div className="relative mt-8">
            ...
            <div className="absolute -bottom-12 -left-4 w-48 h-48 rounded-full bg-[#fbf5f9] flex items-center justify-center p-6 shadow-sm">
              <p className="text-sm text-gray-800 leading-snug font-medium text-center">
