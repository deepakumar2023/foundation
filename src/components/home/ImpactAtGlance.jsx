    ...
    <section className="py-20 bg-gray-50 bg-[url('https://www. foundation.org/-/media/Project/Foundation/Home/Mountain-bg.png')] bg-no-repeat bg-bottom bg-contain" style={{ minHeight: '600px' }}>
      <div className="container mx-auto px-4 xl:px-8">
        <div className="text-center max-w-4xl mx-auto mb-16">
          <h2 className="text-2xl md:text-3xl lg:text-4xl font-medium text-gray-800 leading-relaxed mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center mt-12 relative z-10">
          ...
          <div className="flex flex-col items-center justify-center">
            <div className="w-16 h-16 rounded-full bg-pink-100 flex items-center justify-center mb-4 text-[#8a2176]">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
              </svg>
            </div>
            <div className="text-5xl md:text-6xl font-bold text-gray-700 mb-2">
              {counters.villages.toLocaleString()}
            </div>
            <p className="text-sm text-gray-500 font-medium uppercase tracking-wider">Villages and urban wards</p>
          </div>
          ...
          <div className="flex flex-col items-center justify-center relative">
            ...
            <div className="w-20 h-20 rounded-full bg-pink-100 flex items-center justify-center mb-4 text-[#8a2176]">
            ...
            <p className="text-sm text-gray-500 font-medium uppercase tracking-wider">Lives Touched</p>
          </div>
