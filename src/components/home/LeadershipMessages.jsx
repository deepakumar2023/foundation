    ...
    <section className="py-20 bg-gray-50 relative overflow-hidden">
      <div className="container mx-auto px-4 xl:px-8 max-w-6xl">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-text-main mb-4">Leadership Thoughts</h2>
          ...
          <div className="flex flex-col items-center text-center">
            <div className="w-48 h-48 md:w-56 md:h-56 rounded-full overflow-hidden border-4 border-white shadow-xl mb-8 relative group">
              ...
              <img
                ...
                onError={(e) => {
                  e.target.src = "/deepakgupta.jpeg";
                }}
              />
            </div>
            <h3 className="text-2xl font-bold text-text-main mb-2">Deepak Gupta </h3>
            <p className="text-[var(--color-primary)] font-medium mb-6 uppercase tracking-wider text-sm">CHAIRMAN</p>
            <div className="relative">
              ...
              <p className="text-text-muted text-lg italic leading-relaxed px-4">
          ...
          <div className="flex flex-col items-center text-center">
            <div className="w-48 h-48 md:w-56 md:h-56 rounded-full overflow-hidden border-4 border-white shadow-xl mb-8 relative group">
              ...
              <img
                ...
                className="w-full h-full object-cover object-top transform group-hover:scale-105 transition-transform duration-500"
                onError={(e) => {
                  e.target.src = "/anandgupta.jpeg";
                }}
              />
            </div>
            <h3 className="text-2xl font-bold text-text-main mb-2">ANAND GUPTA </h3>
            <p className="text-[var(--color-primary)] font-medium mb-6 uppercase tracking-wider text-sm">CHAIRPERSON</p>
            <div className="relative">
              <svg className="w-8 h-8 text-gray-300 absolute -top-4 -left-6" fill="currentColor" viewBox="0 0 32 32" aria-hidden="true">
                <path d="M9.352 4C4.456 7.456 1 13.12 1 19.36c0 5.088 3.072 8.064 6.624 8.064 3.36 0 5.856-2.688 5.856-5.856 0-3.168-2.208-5.472-5.088-5.472-.576 0-1.344.096-1.536.192.48-3.264 3.552-7.104 6.624-9.024L9.352 4zm16.512 0c-4.8 3.456-8.256 9.12-8.256 15.36 0 5.088 3.072 8.064 6.624 8.064 3.264 0 5.856-2.688 5.856-5.856 0-3.168-2.304-5.472-5.184-5.472-.576 0-1.248.096-1.44.192.48-3.264 3.456-7.104 6.528-9.024L25.864 4z" />
              </svg>
