      ...
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-[#f5e6f5] rounded-xl p-8 flex flex-col items-center justify-center text-center">
            ...
            <h3 className="text-4xl font-light text-gray-900 mb-2">13+</h3>
          ...
          <div className="bg-[#f5e6f5] rounded-xl p-8 flex flex-col items-center justify-center text-center">
            ...
            <h3 className="text-4xl font-light text-gray-900 mb-2">43+</h3>
            <p className="text-sm text-gray-600">schools built/upgraded</p>
          </div>
          ...
          <div className="bg-[#f5e6f5] rounded-xl p-8 flex flex-col items-center justify-center text-center">
            ...
            <h3 className="text-4xl font-light text-gray-900 mb-2">1,200+</h3>
            <p className="text-sm text-gray-600">schools given smart class</p>
          </div>
          ...
          <div className="bg-[#f5e6f5] rounded-xl p-8 flex flex-col items-center justify-center text-center">
            ...
            <h3 className="text-4xl font-light text-gray-900 mb-2">2</h3>
            <p className="text-sm text-gray-600">medical colleges started</p>
          </div>
        </div>
      </div>
    </div>
