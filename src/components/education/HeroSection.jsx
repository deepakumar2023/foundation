      ...
      <div className="max-w-6xl mx-auto relative h-auto md:h-[600px] flex flex-col md:block items-center space-y-12 md:space-y-0">
        ...
        <div className="md:absolute md:top-[120px] md:right-[5%] flex flex-col md:flex-row-reverse items-center md:items-start max-w-sm">
          ...
          <div className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-sm text-sm relative z-0 md:-mr-12 pt-12 md:pt-6 md:pr-16 text-right">
            <p className="text-gray-700 leading-relaxed">
              <span className="font-bold text-gray-900">Raju Murgaiya</span> - "My father, a fisherman, wants me to become a forest ranger. It has remained a dream because. Walking three kilometers from where...
