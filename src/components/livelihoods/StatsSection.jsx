      ...
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="flex flex-wrap justify-center gap-6">
          ...
          <div className="bg-[#f2f8ec] rounded-xl p-8 flex flex-col items-center justify-center text-center w-full sm:w-64">
            ...
            <h3 className="text-4xl font-light text-gray-900 mb-2">1,50,000+</h3>
          ...
          <div className="bg-[#f2f8ec] rounded-xl p-8 flex flex-col items-center justify-center text-center w-full sm:w-64">
            ...
            <h3 className="text-4xl font-light text-gray-900 mb-2">4,500+</h3>
            <p className="text-sm text-gray-600">youth trained</p>
          </div>
          ...
          <div className="bg-[#f2f8ec] rounded-xl p-8 flex flex-col items-center justify-center text-center w-full sm:w-64">
            ...
            <h3 className="text-4xl font-light text-gray-900 mb-2">350+</h3>
            <p className="text-sm text-gray-600">SHGs formed</p>
          </div>
        </div>
      </div>
    </div>
