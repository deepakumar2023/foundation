      ...
      <div className="max-w-6xl mx-auto text-center">
        ...
        <div className="flex flex-wrap justify-center gap-6">
          ...
          <div className="bg-[#f5e6f5] rounded-xl p-8 flex flex-col items-center justify-center text-center w-full sm:w-64">
            ...
            <h3 className="text-4xl font-light text-text-main mb-2">94,000+</h3>
            <p className="text-sm text-text-muted">anemic women cured</p>
          </div>
          ...
          <div className="bg-[#f5e6f5] rounded-xl p-8 flex flex-col items-center justify-center text-center w-full sm:w-64">
            ...
            <h3 className="text-4xl font-light text-text-main mb-2">986</h3>
            <p className="text-sm text-text-muted">health camps conducted</p>
          </div>
        </div>
      </div>
    </div>
