    ...
    <div className="bg-[#fdf7fd] w-full pt-20 pb-16 px-4 md:px-8 lg:px-16 relative">
      ...
      <div className="max-w-6xl mx-auto flex flex-col items-center md:items-stretch space-y-16 md:space-y-8 py-8">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start max-w-md md:self-start md:ml-[5%]">
          ...
          <div className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-sm text-sm relative z-0 md:-ml-12 pt-12 md:pt-6 md:pl-16">
            <p className="text-gray-700 leading-relaxed">
              <span className="font-bold text-gray-900">Mayur Bhati</span> - "An early diagnosis on complete blood count saved my life. I was feeling sluggish and suddenly very weak. A health camp by Adani Foundation team brought me the diagnosis in timely, before things turned unmanageable... 
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start max-w-md md:self-start md:ml-[10%] md:-mt-12">
          ...
          <div className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-sm text-sm relative z-0 md:-ml-12 pt-12 md:pt-6 md:pl-16">
            <p className="text-gray-700 leading-relaxed">
              <span className="font-bold text-gray-900">Sonalika Sahani</span> - "At 60, my vision completely faded. I had given up on it. But Adani helped. The Mobile clinic found the cataract... The surgical day is here. I will finally see the world."
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row-reverse items-center md:items-start max-w-md md:self-end md:mr-[10%] md:-mt-12">
          ...
          <div className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-sm text-sm relative z-0 md:-mr-12 pt-12 md:pt-6 md:pr-16 text-right">
            <p className="text-gray-700 leading-relaxed">
              <span className="font-bold text-gray-900">Priya Khemka</span> - "My boy Ram was deeply anemic. The doctors at the Adani hospital cared for him. 15 days of admission, complete checkup and free meds. He is recovering and plays cheerfully today."
            </p>
          </div>
        </div>
      ...
      <div className="max-w-4xl mx-auto text-center mt-12 text-sm text-gray-600 leading-relaxed px-4 pb-8 space-y-4">
        ...
        <p>Recognizing the significance of healthcare, the Adani Foundation has taken a strong stand to support this cause. From managing hospitals to running mobile health care units, and conducting specialized health camps, the Foundation is committed to making a difference.</p>
