...
const ImpactStories = () => {
  const stories = [
    ...
    {
      id: 2,
      title: "A New Ray of Hope for Ramkrishna Through Timely Medical...",
      author: "By Healthcare Team",
      image: "https://picsum.photos/400/300?random=35"
    },
    {
      id: 3,
      title: "Project SuPoshan Creating A Wave of Health Awareness in...",
      author: "By Project Coordinator",
      image: "https://picsum.photos/400/300?random=36"
    },
    {
      id: 4,
      title: "Adani Hospitals Continue Their Commitment To Community...",
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {stories.map((story) => (
            <div key={story.id} className="bg-[#faebf6] rounded-2xl p-6 flex flex-col justify-between hover:shadow-lg transition-shadow duration-300">
              ...
              <div className="mb-6">
                <span className="text-xs text-[#a51a70] font-medium tracking-wider uppercase mb-3 inline-block">HEALTH & NUTRITION</span>
