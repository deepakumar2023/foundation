...
const ActiveProgrammes = () => {
  const programmes = [
    ...
    {
      title: "Adani Hospitals: The Promise Of Quality Health",
      description: (
        <>
          <p className="mb-4">Through its comprehensive health care strategy, bringing affordable and accessible medical care to the underprivileged, Adani Foundation is making a difference. The Gujarat Adani Institute of Medical Sciences (GAIMS) is a unique public-private partnership. Equipped with a 750-bed multi-speciality hospital in Bhuj, it caters to thousands of patients annually.</p>
          <p>The Adani hospital in Mundra is a 100-bed multi-speciality facility serving over 50,000 patients annually. In Godda, Jharkhand, the Adani Foundation runs a hospital focusing on maternal and child health. Through these initiatives, the foundation touches millions of lives across communities.</p>
        </>
      ),
    ...
    },
    {
      ...
      description: (
        <>
          <p className="mb-4">The lack of primary healthcare access in remote villages is a major concern. To bridge this gap, Adani Foundation introduced Mobile Health Care Units (MHCUs). These mobile clinics act as first points of contact for villagers, providing essential diagnoses and medicines for free.</p>
