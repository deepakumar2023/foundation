...
const FilterBar = ({ categories, activeCategory, onCategoryChange }) => {
  return (
    <div className="w-full bg-surface py-6 border-b border-gray-200 sticky top-[72px] z-40 shadow-sm">
            ...
            <button
              ...
              className={`whitespace-nowrap px-4 py-2 rounded-full text-sm font-medium transition-colors border ${
                activeCategory === category
                  ...
                  : 'bg-surface border-gray-300 text-text-muted hover:border-[#a51a70] hover:text-[#a51a70]'
              }`}
            >
              {category}
            </button>
