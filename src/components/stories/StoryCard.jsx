    ...
    <div className="bg-[#faebf6] rounded-2xl p-6 flex flex-col justify-between hover:shadow-lg transition-shadow duration-300 h-full border border-[#f0d8e8]">
      ...
      <div className="mb-6 flex flex-col h-full">
        <div className="mb-auto">
          <span className="text-[10px] text-[#a51a70] bg-surface font-bold tracking-widest uppercase mb-4 inline-block px-3 py-1.5 rounded-full shadow-sm border border-[#f0d8e8] hover:bg-[#a51a70] hover:text-white transition-colors cursor-default">
            {tag}
          </span>
          <h3 className="text-lg font-semibold text-text-main leading-snug mb-5 line-clamp-3 hover:text-[#a51a70] cursor-pointer transition-colors duration-300">
            {title}
          </h3>
        </div>
