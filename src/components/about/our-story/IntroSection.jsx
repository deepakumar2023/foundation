...
const IntroSection = () => {
  return (
    <div className="w-full pt-12 pb-16 px-4 md:px-8 lg:px-16 bg-surface">
      {/* Breadcrumbs */}
      <div className="text-sm text-text-muted mb-12 max-w-7xl mx-auto">
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-8 lg:gap-12 items-center lg:items-stretch">
        ...
        <div className="w-full lg:w-2/4 flex flex-col justify-center gap-12 relative px-4 lg:px-8 py-8">
          ...
          <div className="text-center relative">
            ...
            <h1 className="text-2xl md:text-3xl font-light text-text-main mb-4 tracking-wide">
              Story of Change
            </h1>
          ...
          <div className="text-center relative">
            ...
            <h2 className="text-2xl md:text-3xl font-light text-text-main mb-4 tracking-wide">
