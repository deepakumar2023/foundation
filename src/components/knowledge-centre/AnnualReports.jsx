  ...
  return (
    <div className="min-h-screen pt-[100px] md:pt-[120px] lg:pt-[140px] bg-[#f8f9fa]">
      ...
      <section className="px-[16px] md:px-[32px] lg:px-[48px] py-[48px] max-w-[1440px] mx-auto">
        {/* Breadcrumb */}
        <nav className="flex items-center gap-[8px] mb-[32px] text-text-muted font-bold text-[14px]">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-[24px]">
          <div>
            ...
            <p className="text-text-muted text-[18px] md:text-[20px] max-w-2xl leading-relaxed">
          ...
          <div className="relative inline-block w-full md:w-[256px] flex-shrink-0">
            <label className="block font-bold text-[14px] text-text-muted mb-[8px]">Select Year Range</label>
            <div className="relative">
              <select className="w-full appearance-none border border-gray-300 rounded-[8px] px-[16px] py-[12px] bg-surface text-text-main font-bold text-[14px] focus:outline-none focus:ring-2 focus:ring-[#00204f] focus:border-transparent transition-all cursor-pointer">
      ...
      <section className="px-[16px] md:px-[32px] lg:px-[48px] pb-[80px] md:pb-[120px] max-w-[1440px] mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-[24px]">
          {reports.map(({ year, active }) => (
            ...
            >
              <div>
                <p className="font-bold text-[12px] text-text-muted uppercase tracking-widest mb-[8px]">
                  Annual Report
                </p>
